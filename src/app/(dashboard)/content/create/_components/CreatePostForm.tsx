...
import { createPost } from "@/actions/dashboard/posts/createPost";
            ...
            <div className="w-screen md:w-[calc(100vw-280px)] flex flex-col lg:flex-row items-start gap-4 px-12">
                ...
                <div className="lg:w-[50%] hidden md:flex flex-col items-start gap-4">
                    ...
                    <Image
                        ...
                        alt={form.watch('title') || 'Post thumbnail'}
                        width={560}
                        height={240}
                    />
                    ...
                    <p className="text-sm text-muted-foreground font-normal">
                        {form.watch('summary') || 'Your summary or short description here...'}
                    </p>
                    ...
                    <div className="w-full flex items-start gap-6">
                        ...
                        <p className="text-lg font-normal text-muted-foreground">
                            {form.watch('category') ? form.watch('category').charAt(0).toUpperCase() + form.watch('category').slice(1) : 'Category'}
                        </p>
                    </div>
