...
import { getJobType, getStatusColor, getStatusIcon } from "@/lib/job";
import { Play, Loader2, LinkIcon, UploadCloud } from "lucide-react";
...
export function JobCard({ job, showGenerateButton }: JobCardProps) {
  const retryMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('Successfuly added process to queue!')
    },
    onError: (error) => {
